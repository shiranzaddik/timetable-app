...
const STRINGS = {
  en: {
    ...
    colTo: "To",
    colType: "Type",
    classHoursLabel: "School day for this class (hours)",
    classHoursHint:
      "Defaults to the global school day. Use a smaller window if this class ends earlier.",
  ...
  he: {
    ...
    colTo: "עד",
    colType: "סוג",
    classHoursLabel: "שעות לימוד לכיתה זו",
    classHoursHint:
      "ברירת המחדל היא יום הלימודים הכללי. הגדירו טווח קצר יותר אם הכיתה מסיימת מוקדם.",
