...
const STRINGS = {
  en: {
    ...
    fieldSubjectKey: "Key (lowercase id)",
    fieldSubjectName: "Display name (English)",
    fieldSubjectNameHe: "Display name (Hebrew)",
    ...
    errSubjectKeyRequired: "Key is required",
    errSubjectKeyExists: "A subject with this key already exists.",
  ...
  he: {
    ...
    fieldSubjectKey: "מזהה (אנגלית, אותיות קטנות)",
    fieldSubjectName: "שם להצגה (אנגלית)",
    fieldSubjectNameHe: "שם להצגה (עברית)",
    ...
    errSubjectKeyRequired: "יש להזין מזהה",
    errSubjectKeyExists: "כבר קיים מקצוע עם מזהה זה.",
    errCannotRemoveSubjectInUse:
